...
export SENSOR_SOURCE="${SENSOR_SOURCE:-ble}"
...
export BLE_SERVICE_UUID="${BLE_SERVICE_UUID:-12345678-1234-5678-1234-56789abcdef0}"
export BLE_NOTIFY_CHAR_UUID="${BLE_NOTIFY_CHAR_UUID:-12345678-1234-5678-1234-56789abcdef1}"
